...
import lesson_2.InvalidArrayStateException;
import lesson_2.MyArray;

import java.util.Arrays;

public class MyArrayImplHW<E extends Object & Comparable<? super E>> implements MyArray<E> {
    ...
    public MyArrayImplHW() {
        this(INITIAL_CAPACITY);
    }

    @SuppressWarnings("unchecked")
    public MyArrayImplHW(int initialCapacity) {
